...
db_file=~/printer_1_data/database/moonraker-sql.db
...
# cp ~/printer_data/config/moonraker-sql.db ~/printer_1_data/database/
# Finally, restart moonraker

if [ -f $db_file ]; then
   echo "sqlite based history database found! Copying..."
   cp ~/printer_data/database/moonraker-sql.db ~/printer_1_data/config/
else
